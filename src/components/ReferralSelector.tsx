      ...
      {!selectedSpec ? (
                      ...
                      <div className="flex items-center space-x-2.5 min-w-0">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center space-x-1.5">
                            ...
                            {spec.isAdmin && (
                              <span className="text-[9px] bg-amber-400/20 text-amber-600 dark:text-amber-300 border border-amber-400/40 px-1.5 py-0.2 rounded font-bold">
                                Admin
                              </span>
                            )}
                          </div>
                          <div className="text-[11px] text-[#296B6E] dark:text-[#FFB200] font-semibold truncate">
                            {spec.role}
                          </div>
                        </div>
                      </div>

                      <div className="text-[10px] text-slate-400 dark:text-slate-500 font-mono flex items-center gap-1 shrink-0 ml-2">
        ...
        <div className="bg-amber-50/90 dark:bg-amber-950/40 border border-[#FFB200] ring-2 ring-[#FFB200]/20 rounded-2xl p-3.5 flex items-center justify-between animate-in fade-in">
          <div className="flex items-center space-x-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center space-x-1.5">
                ...
                <span className="text-[10px] bg-emerald-100 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-800 px-1.5 py-0.2 rounded font-bold">
                  Wybrano
                </span>
              </div>
              <div className="text-[11px] text-[#296B6E] dark:text-[#FFB200] font-semibold truncate">
              ...
              <div className="text-[10px] text-slate-500 dark:text-slate-400 flex items-center space-x-1 mt-0.5">
                ...
                <span className="font-mono text-slate-600 dark:text-slate-400 truncate">{selectedSpec.email}</span>
              </div>
            </div>
          </div>
          ...
          <button
            type="button"
            onClick={handleClear}
            className="px-2.5 py-1.5 bg-white dark:bg-[#1E1C1A] hover:bg-slate-100 dark:hover:bg-[#2D2A28] text-slate-700 dark:text-slate-300 rounded-xl text-xs font-bold border border-slate-200 dark:border-[#383431] transition-all flex items-center gap-1 cursor-pointer shrink-0 ml-2 shadow-2xs"
        ...
        <div className="mt-3 pt-3 border-t border-slate-200 dark:border-[#2C2927] space-y-2.5 animate-in fade-in">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-white dark:bg-[#1E1C1A] border border-slate-200 dark:border-[#383431] rounded-xl p-2.5 text-xs text-slate-900 dark:text-white focus:ring-2 focus:ring-[#FFB200] focus:border-[#FFB200] focus:outline-none placeholder-slate-400 dark:placeholder-slate-500"
            />
          </div>
        </div>
      )}
