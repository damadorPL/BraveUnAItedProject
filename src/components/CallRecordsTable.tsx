    ...
    <div className="space-y-4 text-xs">
      <div className="flex items-center justify-between">
        <div className="text-slate-600 dark:text-slate-400 font-medium">
          Liczba zarejestrowanych porad: <strong className="text-slate-900 dark:text-white">{filteredRecords.length}</strong>
        </div>
        ...
        {currentSpecialist.isAdmin && (
          <button
            ...
            className="flex items-center space-x-1.5 px-3.5 py-1.5 bg-white dark:bg-[#1E1C1A] hover:bg-slate-50 dark:hover:bg-[#2A2724] text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-[#383431] rounded-xl font-semibold shadow-xs transition-colors cursor-pointer"
          >
      ...
      <div className="bg-white dark:bg-[#1E1C1A] border border-slate-200 dark:border-[#383431] rounded-3xl overflow-hidden shadow-xs">
        {filteredRecords.length === 0 ? (
          <div className="p-8 text-center text-slate-400 dark:text-slate-500">
            ...
            <p className="font-semibold text-slate-700 dark:text-slate-300">Brak porad spełniających zadane kryteria filtrowania.</p>
            <p className="text-[11px] text-slate-400 dark:text-slate-500 mt-0.5">Spróbuj zmienić parametry w filtrze u góry strony.</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-900 dark:bg-[#100F0E] text-white text-[11px] font-bold border-b dark:border-[#2C2927]">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-[#2A2724] text-slate-700 dark:text-slate-300">
                {paginatedRecords.map((rec) => {
                  ...
                  return (
                    <tr
                      ...
                      className="hover:bg-slate-50/80 dark:hover:bg-[#252220] transition-colors cursor-pointer group"
                    >
                      ...
                      <td className="py-3 px-3.5 whitespace-nowrap">
                        {caller ? (
                          <>
                            <div className="font-bold text-slate-900 dark:text-white group-hover:text-[#FFB200] transition-colors">
                      ...
                      <td className="py-3 px-3.5 whitespace-nowrap">
                        <div className="flex items-center text-slate-800 dark:text-slate-200 font-medium">
                          <Users className="w-3 h-3 mr-1 text-[#296B6E] dark:text-teal-400" />
                          {beneficiaryStr}
                        </div>
                        <div className="text-[10px] text-purple-700 dark:text-purple-300 font-semibold mt-0.5 flex items-center">
                      ...
                      <td className="py-3 px-3.5 max-w-xs">
                        <div className="line-clamp-2 text-slate-900 dark:text-slate-100 font-medium">
                      ...
                      <td className="py-3 px-3.5 whitespace-nowrap">
                        <div className="font-medium text-slate-900 dark:text-slate-100">{rec.specialistName}</div>
                        {rec.referredTo && (
                          <div className="text-[10px] text-amber-700 dark:text-amber-300 font-semibold flex items-center gap-1 mt-0.5">
                        ...
                        <div className="flex items-center justify-end space-x-1.5">
                          {canEditRecord(rec) ? (
                            <button
                              ...
                              className="p-1.5 bg-amber-50 dark:bg-amber-950/40 hover:bg-[#FFB200] text-amber-950 dark:text-[#FFB200] dark:hover:text-[#2D2A28] border border-amber-300 dark:border-amber-600/50 rounded-xl transition-all shadow-2xs cursor-pointer"
                          ...
                          <button
                            ...
                            className="px-2.5 py-1.5 bg-amber-50 dark:bg-amber-950/40 hover:bg-[#FFB200] hover:text-[#2D2A28] text-amber-950 dark:text-[#FFB200] font-bold rounded-xl transition-all flex items-center space-x-1 shadow-xs border border-amber-200 dark:border-amber-600/40 cursor-pointer text-xs"
                          >
                            <span>Kartoteka</span>
          ...
          <div className="bg-slate-50 dark:bg-[#161514] border-t border-slate-200 dark:border-[#2C2927] p-3.5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            <div className="flex items-center space-x-3 text-slate-500 dark:text-slate-400 font-medium">
              ...
              <div className="flex items-center space-x-1.5 border-l border-slate-200 dark:border-[#383431] pl-3">
                ...
                <select
                  ...
                  className="bg-white dark:bg-[#22201E] border border-slate-200 dark:border-[#383431] rounded-lg px-2 py-1 font-semibold text-slate-800 dark:text-slate-200 focus:outline-none cursor-pointer"
                >
            ...
            <div className="flex items-center space-x-1.5">
              <button
                ...
                className="flex items-center space-x-1 px-3 py-1.5 bg-white dark:bg-[#22201E] hover:bg-slate-100 dark:hover:bg-[#2E2A27] disabled:opacity-40 disabled:hover:bg-white text-slate-700 dark:text-slate-200 rounded-xl text-xs font-semibold border border-slate-200 dark:border-[#383431] transition-colors cursor-pointer disabled:cursor-not-allowed shadow-2xs"
              >
